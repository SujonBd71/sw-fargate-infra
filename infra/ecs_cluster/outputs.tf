...
output "ecs_alb_listener_arn" {
  value = aws_alb_listener.sw-ecs_alb_https_listener.arn
}

output "ecs_cluster_name" {
  value = aws_ecs_cluster.sw-fargate-cluster.name
}

output "ecs_cluster_role_name" {
  value = aws_iam_role.sw-ecs_cluster_role.name
}

output "ecs_cluster_role_arn" {
  value = aws_iam_role.sw-ecs_cluster_role.arn
}
